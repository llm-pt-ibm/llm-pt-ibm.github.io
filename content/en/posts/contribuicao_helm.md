---
title: "Computação@UFCG Leads Brazil's Contributions to the HELM-Stanford Framework in Partnership with IBM"
date: 2025-07-09 
authors: ["João Brunet"]
tags: ["LLM", "HELM", "IBM"]
projects: ["llm-eval"]
...
draft: false
---
**Collaboration between UFCG’s Computer Science department and IBM makes the university the top brazilian contributor to the [<span class="link-personalizado">HELM-Stanford</span>](https://github.com/stanford-crfm/helm) evaluation framework in 2025.**
...
{{< figure src="/images/carvalheira.jpeg" alt="Multidisciplinary project team" caption="Multidisciplinary project team" >}}

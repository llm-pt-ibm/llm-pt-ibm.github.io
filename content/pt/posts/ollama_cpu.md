...
date: 2026-03-31 # ano-mês-dia
authors: ["Maria Luísa Gomes"] # Pode ser uma lista
tags: ["LLM", "Ollama", "Power9"]
...
{{< figure src="/images/print_ollama_serve.png" alt="Figura 2" caption="Saber se está executando o ollama">}}
...
```
./ollama run tinyllama "qual a cor do céu?"
```

Se tudo tiver sido feito de maneira correta, você terá algo como:

{{< figure src="/images/inferencia_ollama_cpu.png" alt="Figura 3" caption="Inferencia sendo executada">}}

...
summary: "Este post tem como objetivo introduzir e difundir o problema da contaminação de dados de benchmark, apresentando os fundamentos conceituais, causas recorrentes e as metodologias de detecção."
draft: false 
---
...
A contaminação de *benchmarks* provoca distorções que afetam tanto o rigor científico das avaliações quanto a confiabilidade de aplicações baseadas em LLMs. Os principais impactos descritos abaixo, também são discutidos em estudos como <a href="#ref1">[1]</a> <a href="#ref5">[5]</a> <a href="#ref7">[7]</a>.
...
A contaminação de dados de *benchmark* constitui um desafio relevante para a avaliação justa de modelos de linguagem. Como discutido ao longo do texto, esse fenômeno compromete a validade das métricas, dificulta comparações entre LLMs e pode levar à adoção de modelos com desempenho superestimado em aplicações reais.

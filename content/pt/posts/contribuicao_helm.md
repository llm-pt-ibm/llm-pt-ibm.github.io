---
title: "Computação@UFCG lidera contribuições do Brasil ao framework HELM-Stanford em parceria com a IBM"
date: 2025-07-09 
authors: ["João Brunet"]
tags: ["LLM", "HELM", "IBM"]
projects: ["llm-eval"]
...
draft: false
---
**Colaboração entre Ciência da Computação da UFCG e a IBM faz da universidade a maior contribuinte brasileira para o *framework* de avaliação [<span class="link-personalizado">HELM-Stanford</span>](https://github.com/stanford-crfm/helm) em 2025.**
...
{{< figure src="/images/carvalheira.jpeg" alt="Equipe multidisciplinar do projeto" caption="Equipe multidisciplinar do projeto" >}}
